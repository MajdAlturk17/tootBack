...
class MakeGetUseCaseCommand extends Command
{
    protected $signature = 'make:get-use-case {name}';
    protected $description = 'Generate get use case file';
    ...
    public function handle(): void
    {
        ...
        $repositoryPath = app_path("Application/UseCases/{$repositoryName}/Get{$repositoryName}UseCase.php");
        ...
        $this->info("Get '$repositoryName'UseCase generated successfully!");
    }
...
class Get{$repositoryName}UseCase extends GetModelDetailsUseCase
{
