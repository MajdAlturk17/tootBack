...
class MakeUpdateUseCaseCommand extends Command
{
    protected $signature = 'make:update-use-case {name}';
    protected $description = 'Generate update use case file';
    ...
    public function handle(): void
    {
        ...
        $repositoryPath = app_path("Application/UseCases/{$repositoryName}/Update{$repositoryName}UseCase.php");
        ...
        $this->info("Update '$repositoryName'UseCase generated successfully!");
    }
...
class Update{$repositoryName}UseCase extends UpdateModelUseCase
{
